...
var datastarTexture0 = THREE.ImageUtils.loadTexture("assets/images/p_0.png");
var datastarTexture1 = THREE.ImageUtils.loadTexture("assets/images/p_2.png");
var datastarHeatVisionTexture = THREE.ImageUtils.loadTexture("assets/images/sharppoint.png");

//	bright flashy named stars graphic
var starPreviewTexture = THREE.ImageUtils.loadTexture('assets/images/star_preview.png', undefined, setLoadMessage("Focusing optics"));
var starColorGraph = THREE.ImageUtils.loadTexture('assets/images/star_color_modified.png');
...
function generateHipparcosStars() {
    ...
    var starBaseTexture = THREE.ImageUtils.loadTexture('assets/images/starbase.png');
