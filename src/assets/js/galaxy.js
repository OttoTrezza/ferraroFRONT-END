var galacticTexture0 = THREE.ImageUtils.loadTexture("assets/images/galactic_sharp.png");
var galacticTexture1 = THREE.ImageUtils.loadTexture("assets/images/galactic_blur.png");
...
function generateGalaxy() {
    ...
    var galacticTopMaterial = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('assets/images/galactictop.png'),
        blending: THREE.AdditiveBlending,
        depthTest: false,
        depthWrite: false,
