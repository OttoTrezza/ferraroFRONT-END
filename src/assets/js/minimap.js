(function() {
    ...
    $.get('./assets/images/icons/sound-on.svg', function(resp) {
    ...
    $.get('./assets/images/icons/sound-off.svg', function(resp) {
    ...
    $.get('./assets/images/icons/big-tour.svg', function(resp) {
        ...
        $.get('./assets/images/icons/heat-vision.svg', function(resp) {
            ...
            $.get('./assets/images/icons/center-sun.svg', function(resp) {
